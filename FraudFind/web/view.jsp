           ...
           %>
            <br><br>                      
               <table class="comparison-table">
                ...
                <td>COUNTRY</td><td>DATE</td><td>CATOGIRY</td>
                </tr>
                </thead>
                <tbody>
                <%
                		...
                		String sql1="select * from tlog where eid=? and behavioure=?";
                        ...
                        while(rs1.next())
                        {
							String d=rs1.getString("account");
                    	...
                    	for(int i=0; i<list.size(); i++)
                    	{
                    		...
                    		{
                    			System.out.println("list1 is contains.");
                    		}
                    		else
                    		{
                        ...
                        {
                        	String sql2="select * from tlog where account='"+list2.get(i)+"'";
                			...
                			%>
                        	<tr>
                        	<td><%=rs2.getString(1) %></td><td><%=rs2.getString(2) %></td><td><%=rs2.getString(3) %></td>
        					<td><%=rs2.getString(4) %></td><td><%=rs2.getString(5) %></td><td><%=rs2.getString(6) %></td>
        					<td><%=rs2.getString(7) %></td><td><%=rs2.getString(8) %></td><td><%=rs2.getString(9) %></td>
        					<td><%=rs2.getString(10) %></td><td>Intelligent</td>
        					</tr>
                        	<%  
                            }
                        }
