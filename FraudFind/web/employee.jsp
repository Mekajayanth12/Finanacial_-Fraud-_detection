				...
				<div class="navbar-collapse collapse">							
						<div class="menu">
							<ul class="nav nav-tabs" role="tablist">	
								...
								<li role="presentation"><a href="employee.jsp" class="active">Clients</a></li>	
							</ul>
						</div>
					</div>	
			</div>	
        ...
        <div class="container">
            <div class="center">        
               ...
               <table class="comparison-table">
                <thead>
                <tr>
                <td>S.ID</td><td>Acc.No</td><td>COMPANY</td><td>BANK</td><td>ADDRESS</td><td>CITY</td><td>STATE</td><td>COUNTRY</td><td>TRANSACTION</td>
                </tr>
                </thead>
                <tbody>
                <%	
                ...
                while(rs.next())
                {
					...
					<td><%=rs.getString("state") %></td><td><%=rs.getString("country") %></td><td><a href="transfer.jsp?cid=<%=rs.getString("id") %>"><font color="blue">YES</a></td>
					</tr>
                	<%
                }
                %>
