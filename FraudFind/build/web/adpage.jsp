				...
				<div class="navbar-collapse collapse">							
						<div class="menu">
							<ul class="nav nav-tabs" role="tablist">	
								...
								<li role="presentation"><a href="adpage.jsp" class="active">E-Register</a></li>	
							</ul>
						</div>
					</div>	
			</div>	
	...
	<section id="contact-page">
        <div class="container">
            <div class="center">        
                ...
                <thead>
                <tr>
                <td>E.ID</td><td>NAME</td><td>GENDER</td><td>AGE</td><td>ADDRESS</td><td>CITY</td><td>STATE</td><td>COUNTRY</td><td>STATUS</td><td>CONCLUSION</td>
                </tr>
                </thead>
                <tbody>
                <%	
                ...
                while(rs.next())
                {
                	%>
                	<tr>
                	<td><%=rs.getString("eid") %></td><td><%=rs.getString("name") %></td><td><%=rs.getString("gender") %></td>
					<td><%=rs.getString("age") %></td><td><%=rs.getString("address") %></td>
					<td><%=rs.getString("city") %></td><td><%=rs.getString("state") %></td><td><%=rs.getString("country") %></td>
					<td><%=rs.getString("status") %></td>
					<td><a href="accept.jsp?id=<%=rs.getString("id") %>"><font color="blue">ACCEPT</a>
					<a href="reject.jsp?id=<%=rs.getString("id") %>"><font color="red">REJECT</a></td>
					</tr>
                	<%
                }
                %>
